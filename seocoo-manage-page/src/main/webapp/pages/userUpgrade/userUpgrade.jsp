...
<div class="container-order" style="">
	<div class="order-tab">
		<ul class="fl">
		<li class="fl current" data-type="notAudit">升级处理</li>
		</ul>
	</div>
	<div class="order-box" >
...
<div class="today-order">
	<div class="today-order-top">
		...
		<select id="merchant_Select">
			...
			<option value="1">重新绑定</option>
			<option value="2">已完成</option>
		</select>
		<a href="javascript:void(0);" class="check" onclick="searchUserUp()">查询</a>
	</div>
	<div class="today-order-table" id="userUpList">
	</div>
	</div>
