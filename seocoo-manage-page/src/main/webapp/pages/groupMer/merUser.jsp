     ...
     <div>
         <div class="order-tab">
             <ul class="fl">
              ...
              <div class="fr">
             <a href="javascript:void(0);" onclick="loadContent('/groupMer.do?groupCode=${user.groupCode}')"><span><i class="icon-reply"></i></span>返回</a>
         </div>
         </div>
             <div class="muti-marketing">
                     <div class="shop-password">
                         <div class="password">
                             ...
                             <p id="submit"> <a href="javascript:void(0);" onclick="saveMerUser_s('${user.loginName}');">保存</a></p>
                         </div>
                     </div>
