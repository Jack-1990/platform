...
<div class="container-marketing">
	<div class="order-tab">
		...
		<div class="fr">
                        <a href="javascript:void(0);" onclick="loadContent('/groupMer.do?groupCode=${groupCode}')"><span><i class="icon-reply"></i></span>返回</a>
                    </div>
		<div class="fr">
			<a href="javascript:void(0);" class="save" onclick="saveMerchant_s();">保存</a>
		</div>
	</div>
	<div>
		<div class="muti-marketing">
			<form action="" method="post" id="addMerchant" name="addMerchant" enctype="multipart/form-data" encoding="multipart/form-data">
				<input type="hidden" name="merchant.groupCode" id="groupCode" value="${groupCode }" />
				<div class="sales-top">
					<div class="fl">
				...
				<div class="sales-top">
					...
					<div class="fl">
						...
						<input type="text" class="fl" maxlength="11" onchange="checkPhone(this,value)" name="merchant.servTel"> <span class="fl"><i>*</i></span>
					</div>
					<div class="fl">
		...
		<div class="bind-box textc">
			<a href="javascript:void(0);"  onclick="saveMerchant_s()" class="bind-btn">保存</a>
		</div>
	</div>
</div>
<!--加载中 -->
