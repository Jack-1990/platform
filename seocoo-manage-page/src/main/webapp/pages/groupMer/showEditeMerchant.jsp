...
<div class="container-marketing">
	<div class="order-tab">
		...
		<div class="fr">
                        <a href="javascript:void(0);" onclick="loadContent('/groupMer.do?groupCode=${merchant.groupCode}')"><span><i class="icon-reply"></i></span>返回</a>
                    </div>
		<div class="fr">
			<a href="javascript:void(0);" class="save" onclick="saveEditeMerchant_s();">保存</a>
		</div>
	</div>
	<div>
		<div class="muti-marketing">
			<form action="" method="post" id="addMerchant" name="addMerchant" enctype="multipart/form-data" encoding="multipart/form-data">
				<input type="hidden" name="merchant.groupCode"  id="groupCode"  value="${merchant.groupCode }" />
		...
		<div class="bind-box textc">
			<a href="javascript:void(0);"  onclick="saveEditeMerchant_s()" class="bind-btn">保存</a>
		</div>
	</div>
</div>
<!--加载中 -->
