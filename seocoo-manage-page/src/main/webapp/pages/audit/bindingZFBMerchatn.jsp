		...
		<form action="" method="post" id="bindingZFBMerchant" name="bindingZFBMerchant" enctype="multipart/form-data" encoding="multipart/form-data">
			...
			<div class="sales-top">
				...
				<div class="fl" style="margin-left: 10px;">
					<label>类目ID:</label>
					<input type="text" id="categoryID" readonly="readonly" name="payChannel.industryId" value="${payChannel.industryId == null ? '2015110500074890' : payChannel.industryId }" placeholder=""> <i>*</i>
				</div>
				</div>
			</div>
			<div class="sales-top">
				<div class="fl">
					...
					<input type="text" class="fl" name="payChannel.dayLimit" maxlength="12" value="${payChannel.dayLimit == null ? '999999999' : payChannel.dayLimit }"> <span class="fl"><i>*</i>单位：分</span>
				</div>
				<div class="fl">
					<label class="fl">月限额:</label>
					<input type="text" class="fl" name="payChannel.monthLimit" maxlength="12" value="${payChannel.monthLimit == null ? '99999999999' : payChannel.monthLimit }"> <span class="fl"><i>*</i>单位：分</span>
				</div>
				<div class="fl">
					<label class="fl">固定比率费率:</label>
					<input type="text" class="fl" name="payChannel.fixFeeRate" readonly="readonly" maxlength="10" value="${merchantRate.intoRate }"> <span class="fl"><i>*</i>0.50，小数点后精确到2位。两种费率二选一</span>
				</div>
				<div class="fl">
