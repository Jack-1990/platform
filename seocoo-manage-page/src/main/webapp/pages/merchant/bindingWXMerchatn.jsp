		...
		<form action="" method="post" id="bindingWXMerchant" name="bindingWXMerchant" enctype="multipart/form-data" encoding="multipart/form-data">
			...
			<div class="sales-top">
				<div class="fl">
					...
					<input type="text" onblur="value=value.replace(/[^\d]/g,'')" class="fl" name="payChannel.dayLimit" maxlength="12" value="${payChannel.dayLimit }"> <span class="fl"><i>*</i>单位：分</span>
				</div>
				<div class="fl">
					<label class="fl">月限额:</label>
					<input type="text" onblur="value=value.replace(/[^\d]/g,'')" class="fl" name="payChannel.monthLimit" maxlength="12" value="${payChannel.monthLimit }"> <span class="fl"><i>*</i>单位：分</span>
				</div>
			    <div class="fl">
					<label class="fl">固定比率费率:</label>
					<input type="text" class="fl" name="payChannel.fixFeeRate" onchange="fixFreeRateCheck(this,value)" maxlength="10" value="${payChannel.fixFeeRate}" readonly="readonly"> <span class="fl"><i>*</i>0.50，小数点后精确到2位。两种费率二选一</span>
				</div>
				<div class="fl">
