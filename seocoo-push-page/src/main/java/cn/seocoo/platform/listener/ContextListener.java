package cn.seocoo.platform.listener;
...
import cn.seocoo.platform.service.server.AndroidPushServer;
import cn.seocoo.platform.service.server.ScanConnectionPoolThread;
...
public class ContextListener implements ServletContextListener {
	...
	private void initPushThread() {
		...
		new AndroidPushServer().start();
		new ScanConnectionPoolThread().start();
	}
	...
	private void initServletConfig() {
		// 全局保存资源路径
		//String resourcePath=SystemConfigUtil.getSingleProperty("resourcePath_micro").getPropertyValue();
	...
	private void initSystemConfig() {
		...
		// 获取所有的系统配置
		List<SystemConfig> systemConfigList = systemConfigService.getAllSystemConfig();
